...
public:
	...
	std::string JsonJoinGetUserDevicesStatusInfo(const int result, const USER_DEVICES_LIST& userDevicesList);
	...
	std::string JsonJoinGetDeviceUsers(const int result, const std::vector<std::string>& vec_un, const std::string& device_name, const std::string& alarm_time, const int full_alarm_mode);
	...
	bool JsonParseAddDeviceChannel(std::string& device_guid, int& add_sum, std::string& channel_name);
	...
	bool JsonParseGetUserChannels(std::string& username);
	std::string JsonJoinGetUserChannels(const int result, const std::vector<DEVICE_CHANNEL_INFO>& vec_user_channels);
	...
	bool JsonParseModifyDeviceWifiFlag(std::string& device_guid, int& wifi_flag);
	std::string JsonJoinModifyDeviceWifiFlag(const int result);
