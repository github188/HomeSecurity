...
public:
	...
	bool LRange(const std::string& key, const int idx_start, const int idx_stop, std::vector<std::string>& vec_value);
	...
	bool Keys(const std::string& keys_pattern, std::vector<std::string>& vec_keys);
