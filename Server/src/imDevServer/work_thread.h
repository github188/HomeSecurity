...
private:
	...
	static void DoClientTcpRead(struct bufferevent *bev, void *arg);

	static void DoClientTcpError(struct bufferevent *bev, short event, void *arg);
	...
	static bool ClientMessageOpt(const conn* c);
