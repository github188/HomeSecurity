...
bool CJsonOpt::RestructJsonStringToLogic(const char *json_in_string, const int sfd, const int sfd_id, std::string& json_out_string, int& type)
{
	try
	{
	...
	type = in_[JK_LOGIC_PROCESS_TYPE].as_int();
